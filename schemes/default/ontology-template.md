...
正文骨架与校验规则见 `.agent/reference/card-contracts/body-structure.md`（init 后由方案复制或维护）；写法正例见 `.agent/reference/card-contracts/card-exemplars/`（方案源 `schemes/default/card-exemplars/`）。
